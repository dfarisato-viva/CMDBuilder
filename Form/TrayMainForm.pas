...
uses
  ...
  cxTextEdit, Vcl.Samples.Spin, dxSkinsCore, dxSkinBasic, dxSkinBlack,
...
begin
  ...
  begin
    if CDSPath.FieldByName('Type').AsInteger = 0 then
      MenuItem := TMenuItem.Create(MapDrive)
    else
      MenuItem := TMenuItem.Create(DBDrive);
...
//    SvnItem.ImageIndex := 5;
    ...
    if CDSPath.FieldByName('Type').AsInteger = 0 then
      ...
      PathItem.Caption := 'Assign drive ' + edtDBLetter.Text + ':';
